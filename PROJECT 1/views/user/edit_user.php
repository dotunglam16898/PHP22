					...
					<li class="nav-item">
						...
						<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" style="">
							<div class="bg-white py-2 collapse-inner rounded">
								...
								<a class="collapse-item" href="utilities-color.html">Chi tiết bài viết</a>
				...
				<div id="content-wrapper" class="d-flex flex-column">
					...
					<div id="content">
						...
						<div class="container-fluid">
							...
							<!-- Page Heading -->
							<h1 class="h3 mb-4 text-gray-800">Sửa thông tin người dùng</h1>

							<form action="index.php?mod=user&act=update_user" method="POST" role="form" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="file" class="form-control" id="" placeholder="" name="avatar" value="<?php echo $user['avatar'] ?>">
											...
											<!-- <div class="form-group">
												...
												<input type="text" class="form-control" id="" placeholder="" name="avatar" value="<?php echo $user['created_at'] ?>">
											</div> -->
											<div class="form-group">
