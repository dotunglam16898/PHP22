                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <!-- Page Heading -->
                            <h1 class="h3 mb-4 text-gray-800">Sửa thông tin bài viết</h1>

                            <form action="index.php?mod=post&act=update_post" method="POST" role="form" enctype="multipart/form-data">
                               ...
                               <!--  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="" name="description" value="<?php echo $post['slug'] ?>">
                                </div> -->
