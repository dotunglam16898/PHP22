...
<link rel="stylesheet" href="css/animate.css">                                  <!-- Templatemo style -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
                      ...
                      <div class="media tm-related-post wow bounceInUp" data-wow-duration="4s">
                          <div class="media-left media-middle">
                            <a href="#">
                               ...
                               <img src="img<?php echo $post['thumbnail'] ?>" style="width: 100px; height: 100px;"> 
                           </a>
                       </div>
            ...
            <div class="row tm-margin-t-big ">
               <!--  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="tm-content-box">
                        <img src="img/VVK.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 wow bounceInRight">

                  <div class="tm-content-box">
                    <img src="img/HSthoicovid.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
              ...
              <div class="tm-content-box">
                <img src="img/Co-be-Mexico-8-tuoi-thong-minh-mot-cach-ky-la-1-1583815708-58-width598height391.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
                <h4 class="tm-margin-b-20 tm-gold-text">Thần đồng Mexico tốt nghiệp THPT khi mới 8 tuổi
                </h4>
                <p class="tm-margin-b-20"></p>
                <a href="/PROJECT%201/views/frontend/detail_blog.php?id=30" class="tm-btn text-uppercase">Chi tiết</a>    
            </div>  
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
            <div class="tm-content-box">
                <img src="img/THPT.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
                <h4 class="tm-margin-b-20 tm-gold-text">Quy chế tuyển sinh:Những điểm mới quan trọng
                </h4>
                <p class="tm-margin-b-20"></p>
                <a href="/PROJECT%201/views/frontend/detail_blog.php?id=28" class="tm-btn text-uppercase">Chi tiết</a>    
            </div>  
