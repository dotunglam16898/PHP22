...
<section class="tm-section">
    <div class="container-fluid">
        ...
        <div class="row wow slideInLeft " data-wow-duration="2s" >
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-xs-center">
                <h2 class="tm-gold-text tm-title " >Bài viết có lượt xem nhiều</h2>
        ...
        <div class="row">
            ...
            <h2 class="tm-gold-text tm-title " style="padding-top: 95px">Bài viết khác</h2>

            <div class="row tm-margin-t-big">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">

                    <div class="tm-content-box">
                        <img src="views/frontend/img/covid.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
                        ...
                        <a href="/PROJECT%201/views/frontend/detail_blog.php?id=16" class="tm-btn text-uppercase">ĐỌC TIẾP</a>    
                    </div>  
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="tm-content-box">
                        <img src="views/frontend/img/ship.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
                        <h4 class="tm-margin-b-20 tm-gold-text">Tàu Trung Quốc lại ngang ngược cấm đánh bắt ở biển Đông</h4>
                        <p class="tm-margin-b-20"></p>
                        <a href="/PROJECT%201/views/frontend/detail_blog.php?id=17" class="tm-btn text-uppercase">ĐỌC TIẾP</a>    
                    </div>  
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="tm-content-box">
                        <img src="views/frontend/img/samsung.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
                        <h4 class="tm-margin-b-20 tm-gold-text">Làm thế nào để giải quyết những vấn đề chụp ảnh này ban đêm: mờ nhoè</h4>
                        <p class="tm-margin-b-20"></p>
                        <a href="/PROJECT%201/views/frontend/detail_blog.php?id=23" class="tm-btn text-uppercase">ĐỌC TIẾP</a>    
                    </div>  
        ...
        <aside class="col-xs-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 tm-aside-r">
            ...
            <div class="tm-aside-container">
                <!--  <img src="" alt="Image" class="tm-margin-b-20 img-fluid " > -->
                <h4 class="tm-margin-b-20 tm-gold-text"></h4>
