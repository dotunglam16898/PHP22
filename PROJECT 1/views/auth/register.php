    ...
    <div class="card o-hidden border-0 shadow-lg my-5">
      <div class="card-body p-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form class="user" method="POST" action="/PROJECT%201/index.php?mod=auth&act=register">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <input type="text" class="form-control form-control-user" id="exampleFirstName" placeholder="Username" name="name">
                  </div>
       ...
       <!--  <a href="login.html" class="btn btn-primary btn-user btn-block">
        ...
        <tr>
          <td colspan="2" align="center"> <input type="submit" name="btn_submit" value="Register" class="btn btn-primary btn-user btn-block"></td>
        </tr>
        <hr>
      ...
      <div class="text-center">
        <a class="small" href="/PROJECT%201/index.php?mod=auth&act=login">Already have an account? Login!</a>
      </div>
    </div>
  </div>
</div>
