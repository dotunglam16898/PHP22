            ...
            <table class="table">
                ...
                // Tính tổng số tiền của giỏ hàng
                        ...
                        <tr>
                            ...
                            <td>
                            	<a href="addToCart.php?msp=<?= $product['MaSP']?>" class="btn btn-primary">+</a>
                                <?php echo $product['SoLuong'] ?>
                                <a href="remove_product.php?msp=<?= $product['MaSP']?>" class="btn btn-primary">-</a>
                            </td>
                            <td><img style="width: 20%;height: 10%;" src="<?php echo $product['Anh'] ?>" ></td>
                            <td><?php echo $product['time'] ?></td>
                            <td>
                                <a class="btn btn-danger" href="cart_delete.php?msp=<?php echo $product['MaSP'] ?>" title="">Xóa giỏ hàng</a>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
